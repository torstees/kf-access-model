# Contributing to kf-access-model

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
kf-access-model. These guidelines are not strict rules.
...
The kf-access-model team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the kf-access-model technical leads
...
[issues]: https://github.com/carrollaboratory/kf-access-model/issues/
[pulls]: https://github.com/carrollaboratory/kf-access-model/pulls/
